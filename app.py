...
st.sidebar.image('https://banner2.cleanpng.com/20180529/eep/kisspng-summer-olympic-games-questagame-olympic-symbols-20-olympic-rings-5b0cebab941944.6196942215275734196066.jpg')
...
if user_menu == 'Overall Analysis':
    ...
    athelet_over_time = helper.data_over_time(df, 'Name')
    fig = px.line(athelet_over_time, x="Year", y="count")
